...
geno.pc <- read.table("AD_736_multi_ethnic_chip_updated_eQTL_inds_snps_removed_noLD_noLD_genotyping_pca_clean.eigenvec", sep="", header=F, row.names=2)
eigenvals <- read.delim("AD_736_multi_ethnic_chip_updated_eQTL_inds_snps_removed_noLD_noLD_genotyping_pca_clean.eigenval", 
                        sep="", header=F)
